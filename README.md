...
- training larger YOLO models (YOLO11s / YOLO11m)
- experimenting with **transformer-based detection models**
- semi-supervised learning for missing annotations
- deployment as a **mobile agricultural diagnostic system**
